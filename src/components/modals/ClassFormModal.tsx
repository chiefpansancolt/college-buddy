...
interface ClassFormModalProps {
	isOpen: boolean;
	onClose: () => void;
	onSubmit: (classData: CreateClassData, assignments: CreateAssignmentData[]) => Promise<void>;
...
export default function ClassFormModal({
	...
	const [activeTab, setActiveTab] = useState<"class" | "assignments">("class");
	...
	return (
		<Modal show={isOpen} onClose={handleClose} size="2xl">
			...
			<ModalBody>
					...
					<div className="space-y-6">
						...
						<div>
							<div className="mb-3 flex items-center justify-between">
								...
								<Button size="xs" onClick={addScheduleSlot} disabled={isLoading}>
							...
							{formData.schedule.length === 0 ? (
								<p className="text-sm text-gray-500 dark:text-gray-400">
									No schedule added yet. Click "Add Time Slot" to add class times.
								</p>
							) : (
				...
				{activeTab === "assignments" && !editingClass && (
					<div className="space-y-6">
						<div className="flex items-center justify-between">
							<div>
								...
								<p className="text-sm text-gray-600 dark:text-gray-400">
									Add multiple assignments that will be created along with the
									class
								</p>
							</div>
							<Button size="sm" onClick={addAssignment} disabled={isLoading}>
						...
						{assignments.length === 0 ? (
							<Card className="py-8 text-center">
								<p className="text-gray-500 dark:text-gray-400">
									No assignments added yet. Click "Add Assignment" to start adding
									assignments.
								</p>
							</Card>
						) : (

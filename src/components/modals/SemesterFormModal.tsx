...
import { CreateSemesterData, Semester, SemesterStatus, SemesterType } from "@/types/app/app";
...
export default function SemesterFormModal({
	...
	return (
		<Modal show={isOpen} onClose={handleClose} size="lg">
			<ModalHeader>{editingSemester ? "Edit Semester" : "Add New Semester"}</ModalHeader>
			<ModalBody>
